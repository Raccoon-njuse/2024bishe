...
port = 1883  # mqtt默认端口
subTopic = "command/device2/#"  # 订阅mqtt指令话题，可使用/分隔
...
def forward():
    # TODO: 发布话题启动小车
    print("ROS Car2 start running...")


def stop():
    # TODO: 发布话题停止小车
    print("ROS Car2 stop running...")


def backward():
    # TODO 后退
    print("ROS Car2 backward")


def left():
    # TODO 左转
    print("ROS Car2 right")
...
def setVelocity(velocity):
    ...
    print(f'Setting Velocity to Car2: {velocity} m/s...')


def getVelocity():
    # TODO: 读出小车速度并返回
    print(f'Car2 Current Velocity is: {velocity} m/s...')
    return velocity


def getCameraUrl():
    # TODO: 获取小车摄像头图像流的url并返回
    print(f'Car2 Camera Url is: {cameraUrl}')
    return cameraUrl


def getDotCloud():
    # TODO: 获取小车激光雷达点云矩阵，字符串化并返回
    print(f'Car2 DotCloud is: {dotCloud}')
    return dotCloud
